...
**医者**  
医者が持つ鉄剣は、他プレイヤーに対してダメージではなく回復（体力ゲージがマックスのときは再生効果II）を与える。<br>また、プレイヤーに右クリックでそのプレイヤーの残り体力がわかる。
...
| <item-sprite name="potion-of-instant health"/>回復のポーション|体力を8回復する。|
